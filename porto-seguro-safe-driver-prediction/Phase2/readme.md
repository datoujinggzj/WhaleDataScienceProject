...
- <font color='#3198FB'>掌握5大变量类型的联系与区别</font>
- <font color='#3198FB'>掌握元数据框架、构建方法、对于高维数据的使用价值和好处</font>
- <font color='#3198FB'>熟悉基于元数据的描述性分析方法</font>
- <font color='#3198FB'>掌握Matplotlib</font> 🆕
